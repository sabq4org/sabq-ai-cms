...
[![Next.js](https://img.shields.io/b### 📢 نظام الإعلانات والتنبيهات الإدارية

- **شريط بانر ذكي**: تنبيهات عاجلة في أعلى لوحة التحكم
- **الخط الزمني**: عرض منظم للإعلانات المهمة والمجدولة
- **نظام صلاحيات متقدم**: توجيه دقيق حسب الأدوار والمستخدمين
- **جدولة تلقائية**: تفعيل وأرشفة آلية للإعلانات
- **أنواع متعددة**: إعلانات، تنبيهات حرجة، إرشادات، موافقات
- **مرفقات ذكية**: دعم الصور والملفات والروابط

📢 **[دليل نظام الإعلانات الكامل](./docs/admin-announcements-system.md)**  
🔧 **[تقرير إصلاح أخطاء البناء](./ANNOUNCEMENTS_BUILD_FIX_REPORT.md)**js-15-black)](https://nextjs.org/)
...
│   ├── admin-announcements-system.md  # دليل نظام الإعلانات
...
- **[دليل نظام الإعلانات](./docs/admin-announcements-system.md)** - نظام الإعلانات والتنبيهات الإدارية
...
├── admin-announcements-system.md   # نظام الإعلانات والتنبيهات
