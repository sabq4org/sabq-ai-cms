...
export default function ArticleStats({
  ...
  const statItems = [
    ...
    },
    {
      ...
      label: "إعجاب",
      color: stats.userInteractions.hasLiked
    ...
    },
    {
      ...
      value: stats.saves.formatNumber,
      label: "حفظ",
      color: stats.userInteractions.hasSaved
    ...
    {
      icon: ShareIcon,
      value: stats.shares.formatNumber,
      label: "مشاركة",
    ...
    },
    {
      ...
      value: stats.comments.formatNumber,
      label: "تعليق",
        ...
        {statItems.map((item, index) => (
          <motion.div
            ...
            className={`
              ...
              ${
                item.interactive
                  ? "cursor-pointer hover:shadow-xl hover:shadow-gray-200/50 dark:hover:shadow-gray-900/50"
                  : ""
              }
              ${
                isLoading && item.interactive
          ...
          >
            ...
            <div className="relative mb-4">
              <div
                className={`w-12 h-12 ${item.iconBg} rounded-xl mx-auto flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform duration-300`}
              >
