  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        title: "إدارة الزوايا",
        icon: Zap,
        href: "/admin/muqtarab/corners",
      },
      {
        id: "muqtarab-articles",
        title: "إدارة المقالات",
        icon: FileText,
        href: "/admin/muqtarab/articles",
      },
      {
        id: "muqtarab-analytics",
        title: "التحليلات",
        icon: BarChart3,
        href: "/admin/muqtarab/analytics",
      },
      {
        id: "muqtarab-settings",
        title: "إعدادات الذكاء الاصطناعي",
        icon: Brain,
        href: "/admin/muqtarab/settings",
      },
    ],
  },
  {
