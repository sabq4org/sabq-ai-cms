...
export default function ResponsiveHome({ isMobile = false }: ResponsiveHomeProps) {
  ...
  useEffect(() => {
    // محاكاة تحميل البيانات للنسخة المحمولة
    if (isMobile) {
      setTimeout(() => {
        ...
        <div className="mt-12 text-center">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            >
              ...
              <div className="font-medium mb-1">سريع جداً</div>
              <div className="text-xs text-gray-600">تحميل فائق السرعة</div>
            </div>
            ...
            >
              <div className="text-2xl mb-2">📱</div>
              <div className="font-medium mb-1">محمول أولاً</div>
              <div className="text-xs text-gray-600">مُحسّن للهواتف</div>
            </div>
            ...
            >
              <div className="text-2xl mb-2">🎨</div>
              <div className="font-medium mb-1">ألوان ديناميكية</div>
              <div className="text-xs text-gray-600">نظام ألوان متقدم</div>
            </div>
            ...
            >
              <div className="text-2xl mb-2">🌙</div>
              <div className="font-medium mb-1">وضع ليلي</div>
              <div className="text-xs text-gray-600">راحة للعينين</div>
            </div>
          </div>
        </div>
      </div>
