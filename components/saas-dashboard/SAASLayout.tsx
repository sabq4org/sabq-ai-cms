...
export default function SAASLayout({
  ...
  return (
    <div className={`saas-main-bg min-h-screen ${darkMode ? 'saas-dark-support' : ''}`}>
      {/* Sidebar */}
      <SAASSidebar 
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="saas-card">
          ...
          <div className="h-64 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg 
        ...
        <div className="saas-card">
          ...
          <div className="space-y-3">
            {[
              { user: "أحمد محمد", action: "أعجب بمقال الذكاء الاصطناعي", time: "منذ 5 دقائق" },
              { user: "فاطمة أحمد", action: "علقت على تحليل السوق", time: "منذ 10 دقائق" },
              { user: "محمد علي", action: "شارك مقال التكنولوجيا", time: "منذ 15 دقيقة" }
            ].map((activity, index) => (
