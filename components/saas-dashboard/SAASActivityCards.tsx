  ...
  const defaultActivities: ActivityItem[] = [
    {
      ...
      description:
        "تم نشر مقال جديد في قسم التكنولوجيا حول أحدث التطورات في مجال الذكاء الاصطناعي",
      status: "completed",
      type: "article",
    ...
    },
    {
      ...
      description:
        "يتم حالياً إعداد تحليل عميق حول اتجاهات السوق في الربع الأول",
      status: "in_progress",
      type: "analysis",
  ...
  return (
    <div className="space-y-6">
      ...
      {showFilters && (
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="saas-btn-primary">إنشاء نشاط جديد</button>
          </div>
        </div>
      )}
        ...
        {limitedActivities.map((activity) => {
          ...
          return (
            <div
              key={activity.id}
              className={`
                saas-card saas-hover-lift border-l-4 ${getPriorityColor(
                  activity.priority
                )}
                ${
                  darkMode
      ...
      <div className="text-center">
        <button className="saas-btn-secondary">عرض المزيد من الأنشطة</button>
      </div>
    </div>
  );
}
