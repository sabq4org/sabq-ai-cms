...
export default function EnhancedMobileStatsBar({
  ...
  if (loading) {
    return (
      <div
        className={`${className} ${darkMode ? "bg-gray-900" : "bg-white"}
      ...
      <div className="px-3 py-3">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-2 rtl:space-x-reverse">
            <div
              className={`stats-icon-container p-1.5 rounded-full ${
            ...
            <span
              className={`stats-text text-sm font-bold ${
            ...
            <div
              className={`live-indicator w-2 h-2 rounded-full ${
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          ...
          <div
            className={`stats-card-enhanced relative overflow-hidden rounded-xl p-4
            bg-gradient-to-br ${
              darkMode
          ...
          >
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center space-x-2 rtl:space-x-reverse">
                <div
                  className={`stats-icon-container p-2 rounded-lg ${
                ...
                <div>
                  <span
                    className={`stats-text text-xs font-medium ${
                      darkMode ? "text-blue-300" : "text-blue-700"
                    }`}
                  >
                    أخبار اليوم
              ...
              {stats.daily_change && (
                <div
                  className={`trend-indicator flex items-center space-x-1 rtl:space-x-reverse px-2 py-1
                  rounded-full text-xs font-bold border-2 ${getTrendColor(
                    stats.daily_change.direction
                  )}`}
                >
            ...
            {/* الرقم الرئيسي */}
            <div
              className={`stats-number text-2xl font-black mb-1 ${
                darkMode ? "text-white" : "text-gray-900"
              }`}
            >
          ...
          >
            ...
            <div
              className={`absolute -bottom-2 -left-2 w-8 h-8 rounded-full opacity-20 ${
        ...
        <div className="grid grid-cols-4 gap-2">
          {/* التصنيفات */}
          <div
            className={`stats-card-enhanced text-center p-3 rounded-lg ${
              darkMode
