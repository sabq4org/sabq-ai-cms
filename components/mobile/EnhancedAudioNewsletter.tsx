...
export default function EnhancedAudioNewsletter({
  ...
  const fetchLatestEpisode = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/audio/episodes?limit=1&status=published');
      ...
      <div className={`${className} ${
        ...
        <div className="text-center py-6">
          ...
          <p className={`text-sm mb-4 ${
            ...
            سيتم إضافة النشرة الصوتية قريباً. في هذه الأثناء، يمكنك متابعة آخر الأخبار بالنص.
          </p>
  ...
  return (
    <div className={`${className} ${
      ...
      <div className={`p-4 border-b ${
        darkMode ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50'
      }`}>
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 rtl:space-x-reverse">
                ...
                <span className={`text-xs ${
                  ...
                  {new Date(currentEpisode.created_at).toLocaleDateString('ar-SA')}
                </span>
              </div>
            </div>
          </div>
