...
export function StaticHeader() {
  ...
  useEffect(() => {
    const checkNewEvents = async () => {
      try {
        const response = await fetch('/api/news/fast?status=published&limit=10&order=desc&noCount=1&fields=id,title,slug,published_at');
  ...
  return (
    <div className="bg-white dark:bg-gray-900 shadow-sm sticky top-0 z-50 transition-colors duration-300 border-b border-gray-200 dark:border-gray-700">
