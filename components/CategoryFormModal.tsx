        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label
                htmlFor="name_ar"
                className={`mb-1 block ${darkMode ? "text-gray-200" : ""}`}
              >
                الاسم بالعربية <span className="text-red-500">*</span>
              </Label>
              <Input
                id="name_ar"
                {...register("name_ar", { required: "الاسم بالعربية مطلوب" })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <Label
                className={`mb-2 block ${darkMode ? "text-gray-200" : ""}`}
              >
                لون التصنيف
              </Label>
                ...
                {categoryColors.map((color) => (
                  <button
                    ...
                    className={`w-9 h-9 rounded-full border-2 transition-all duration-150 ${
                      watchColorHex === color.value
                        ? "border-blue-500 ring-2 ring-blue-500 scale-110"
                  ...
                  <div className="flex flex-wrap gap-2">
                    {categoryIcons.map((icon) => (
                      <button
                        ...
                        className={`w-10 h-10 rounded-lg border-2 text-xl flex items-center justify-center transition-all duration-150 ${
                          field.value === icon
          ...
          {/* Cover Image */}
          <div>
            <Label className={`mb-2 block ${darkMode ? "text-gray-200" : ""}`}>
              صورة الغلاف
            </Label>
              ...
              {watchCoverImage ? (
                <div className="relative group w-full h-48">
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center rounded-md">
                    <button
                      ...
                      className="text-white text-sm flex items-center gap-2 bg-red-600/80 px-4 py-2 rounded-lg"
                    >
                ...
                <div className="space-y-3 py-6">
                  ...
                  <p className="text-sm text-gray-500">
                    اسحب الصورة إلى هنا أو اضغط للاختيار
                  </p>
                  <Button
                    type="button"
                    variant="outline"
