...
export default function PreferencesPage() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        // استخدام setTimeout لتجنب مشكلة الـ rendering أثناء state update
        setTimeout(() => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      // تسجيل البيانات قبل الإرسال للتحقق
      console.log("📋 البيانات المُرسلة من Frontend:", {
        userId: userId,
        categoryIds: selectedCategoryIds,
        categoryIdsType: typeof selectedCategoryIds,
        categoryIdsLength: selectedCategoryIds?.length,
        source: "onboarding",
      });
  ...
  }, [selectedCategoryIds, user, router]);
                ...
                {hasExistingInterests ? (
                  <>
                    ...
                    <span className="text-lg text-gray-500">
                      يمكنك اختيار من 3 إلى {Math.min(10, categories.length)}{" "}
                      تصنيفات
                    </span>
                  </>
                ) : (
                  <>
                    ...
                    تصنيفات لنقدم لك محتوى مخصص يناسب اهتماماتك
                    <br />
                    <span className="text-lg text-gray-500">
                      يمكنك اختيار من 3 إلى {Math.min(10, categories.length)}{" "}
                      تصنيفات
