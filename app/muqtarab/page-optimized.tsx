...
export const metadata = {
  ...
  description:
    "اكتشف عوالم مُقترب المتنوعة من المحتوى الإبداعي والمقالات المتخصصة في التقنية والثقافة والابتكار",
...
async function getMuqtarabData() {
  try {
    ...
    const uniqueFeaturedArticles = (data.featuredArticles || []).filter(
      (art: any) => {
  ...
  return (
    <>
      ...
      <Suspense fallback={<MuqtarabPageSkeleton />}>
        <MuqtarabClientContent initialData={data} />
      </Suspense>
    </>
  );
}
