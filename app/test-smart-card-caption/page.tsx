...
export default function TestSmartCardCaption() {
  ...
  const sampleArticle = {
    ...
    slug: "test-123",
    featured_image:
      "https://res.cloudinary.com/dlaibl7id/image/upload/v1753111461/defaults/article-placeholder.jpg",
    category_name: "تقنية",
    excerpt:
      "اكتشف كيف يُحدث الذكاء الاصطناعي ثورة في عالم الصحافة الرقمية وتأثيره على مستقبل المحتوى",
