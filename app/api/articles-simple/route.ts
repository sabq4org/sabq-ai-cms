...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (updateData.excerpt !== undefined)
      updatePayload.excerpt = updateData.excerpt;
    ...
    if (updateData.breaking !== undefined)
      updatePayload.breaking = updateData.breaking;
    if (updateData.featured_image !== undefined)
      updatePayload.featured_image = updateData.featured_image;
