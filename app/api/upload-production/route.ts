...
export async function POST(request: NextRequest) {
  console.log('📸 [IMAGE UPLOAD - PRODUCTION SAFE] بدء رفع صورة آمن للإنتاج...');
  ...
  try {
    ...
    const placeholderUrl = `https://via.placeholder.com/800x600/6B7280/FFFFFF?text=${encodeURIComponent('خطأ في الرفع')}`;
