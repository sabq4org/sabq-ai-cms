...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `أجب بإيجاز وبالعربية على السؤال التالي بالاعتماد على المعلومات المذكورة في النص وسياقها المباشر،
مع السماح باستنتاجات وتحليل معقول دون إدخال حقائق خارجية مؤكدة.
نوع الإجابة المطلوب: ${style}. إذا كانت الإجابة المباشرة غير متاحة، قدم خلاصة تحليلية مبنية على ما ورد وتداعياته.
