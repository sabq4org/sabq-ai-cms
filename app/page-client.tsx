  ...
  return (
    ...
    >
      ...
      >
        ...
        <SafeHydration>
          {isMobileView && (
            <div className="pulse-ticker-mobile pulse-first-element" style={{ marginTop: '-56px', paddingTop: '56px' }}>
        ...
        <SafeHydration>
          {!isMobileView && (
            <div className="pulse-ticker-desktop pulse-first-element" style={{ marginTop: '-64px', paddingTop: '64px' }}>
