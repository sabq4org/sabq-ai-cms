...
const SabqAICompanion = dynamic(() => import("@/components/article/SabqAICompanion"), {
  ssr: false,
  loading: () => null
});

const SmartInteractions = dynamic(() => import("@/components/article/SmartInteractions"), {
  ssr: false,
  loading: () => (
...
const NextKnowledgeJourney = dynamic(() => import("@/components/article/NextKnowledgeJourney"), {
  ssr: false,
  loading: () => (
...
interface SmartArticleWrapperProps {
  children: React.ReactNode;
  article: any;
  insights: any;
}

export default function SmartArticleWrapper({ children, article, insights }: SmartArticleWrapperProps) {
