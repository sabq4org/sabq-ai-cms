...
export default function ArticlesManagementPage() {
  ...
  useEffect(() => {
    fetchCorners();
    fetchArticles();
  }, [pagination.page, searchTerm, statusFilter, cornerFilter, sentimentFilter]);
    ...
    <DashboardLayout>
      <div className="space-y-6" dir="rtl">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">إدارة المقالات</h1>
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">لا توجد مقالات</h3>
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-gray-600 dark:text-gray-400">
                              <p>بقلم: <span className="font-medium">{article.author_name}</span></p>
                              <p>في زاوية: <span className="font-medium">{article.corner_name}</span></p>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          {article.ai_compatibility_score > 0 && (
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-blue-600">{article.ai_compatibility_score}%</span>
                            </div>
                          )}
                        </div>
                      ...
                      <div className="flex items-center justify-end">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                              onClick={() => router.push(`/admin/muqtarab/articles/${article.id}/edit`)}
                            >
            ...
            {pagination.pages > 1 && (
              <div className="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-gray-700">
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  عرض {((pagination.page - 1) * pagination.limit) + 1} إلى {Math.min(pagination.page * pagination.limit, pagination.total)} من {pagination.total} مقال
                </div>
