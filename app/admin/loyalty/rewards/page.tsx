...
export default function AdminLoyaltyRewardsPage() {
  ...
  const [typeFilter, setTypeFilter] = useState<
    "all" | "physical" | "digital" | "discount" | "points"
  >("all");
    ...
    const mockRewards: Reward[] = [
      {
        ...
        description:
          "قسيمة خصم بقيمة 50 ريال سعودي قابلة للاستخدام في جميع المتاجر الشريكة",
        type: "discount",
        pointsCost: 500,
        originalPrice: 50,
        discountPercent: 10,
  ...
  const totalPointsUsed = rewards.reduce(
    (sum, r) => sum + r.redeemedCount * r.pointsCost,
    0
  );
