    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-[56px] sm:pt-[64px]">
        ...
        <div className="relative">
          <article className="w-[95%] md:w-[80%] mx-auto py-4 sm:py-6 lg:py-8">
            {/* رأس المقال */}
            ...
            {article.category && (
              <Link
                ...
                className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium mb-3 sm:mb-4 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border border-blue-200/50 dark:border-blue-700/50 hover:bg-blue-100 dark:hover:bg-blue-800/30 transition-all"
              >
        ...
        {/* منطقة المحتوى */}
        <article className="w-[95%] md:w-[80%] mx-auto pb-8">
