...
export default function DashboardPage() {
    ...
    const fetchRealData = async () => {
      try {
        ...
        if (statsRes.ok) {
          ...
          if (statsData.topArticles && statsData.topArticles.length > 0) {
            ...
            if (articlesRes.ok) {
              ...
              const topArticlesWithTitles = statsData.topArticles.map(
                (item: any) => {
        ...
        if (activitiesRes.ok) {
          ...
          const formattedActivities = activitiesData.activities
            .slice(0, 4)
            .map((activity: any) => {
  ...
  const CircularStatsCard = ({
    ...
    <div
      className={`rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-6 shadow-sm border transition-colors duration-300 hover:shadow-md ${
        darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-100"
      }`}
    >
      <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
        <div
          className={`w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 ${bgColor} rounded-full flex items-center justify-center flex-shrink-0`}
        >
          <Icon
        ...
        <div className="flex-1 min-w-0">
          <p
            className={`text-xs sm:text-sm mb-0.5 sm:mb-1 truncate transition-colors duration-300 ${
          ...
          <div className="flex items-baseline gap-1 sm:gap-2">
            <span
              className={`text-base sm:text-lg lg:text-2xl font-bold transition-colors duration-300 ${
  ...
  const DataTable = () => {
    ...
    const MobileCard = ({ row }: { row: any }) => (
      <div
        className={`${tableColors.containerBg} rounded-lg p-4 border ${tableColors.containerBorder} mb-3`}
      >
        ...
        <div className="space-y-2 text-xs">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`text-xs ${tableColors.subText}`}>
                {row.engagement}
              </span>
            </div>
          </div>
    ...
    return (
      <>
        ...
        <div
          className={`hidden md:block ${tableColors.containerBg} rounded-2xl shadow-sm border ${tableColors.containerBorder} overflow-hidden transition-colors duration-300`}
        >
          <div
            className="px-4 sm:px-6 py-4"
            style={{ borderBottom: `1px solid ${tableColors.cellBorder}` }}
          >
            <h3
              className={`text-base sm:text-lg font-semibold ${tableColors.titleText} transition-colors duration-300`}
            >
          ...
          <div className="overflow-x-auto">
            ...
            >
              <div className="grid grid-cols-7 gap-4 px-4 sm:px-6 py-4">
                <div
                  className={`text-xs sm:text-sm font-medium ${tableColors.headerText} transition-colors duration-300`}
                >
                  الفئات المفضلة
                </div>
                <div
            ...
            {/* بيانات الجدول */}
            <div
              style={{ borderColor: tableColors.cellBorder }}
              className="divide-y min-w-[800px]"
            >
              {loading ? (
        ...
        <div
          className={`md:hidden ${tableColors.containerBg} rounded-xl p-4 border ${tableColors.containerBorder}`}
        >
          <h3
            className={`text-base font-semibold ${tableColors.titleText} mb-4`}
          >
            سلوك المستخدمين الأكثر نشاطاً
          </h3>
          {loading ? (
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link href="/admin/news/create-new" className="group">
              <div
                className={`relative overflow-hidden rounded-2xl p-6 text-center transition-all duration-300 hover:scale-105 ${
                  darkMode
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
          ...
          >
            ...
            <Link
              ...
              className={`block w-full mt-6 px-4 py-3 rounded-lg font-medium transition-all duration-300 text-center ${
                darkMode
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {recentActivities.length > 0 ? (
                recentActivities.map((activity, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`flex items-start gap-3 p-3 rounded-lg transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-700/50`}
                    >
                      <div
                        className={`p-2 rounded-lg bg-${activity.color}-500/10`}
                      >
                        <Icon
          ...
          >
            ...
            >
              ...
              <Link
                href="/dashboard/analytics/articles"
              ...
              {topArticles.length > 0 ? (
                topArticles.map((article) => (
                  <Link
                    ...
                    className={`flex items-center gap-3 p-3 rounded-lg transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer`}
                  >
                    <div
