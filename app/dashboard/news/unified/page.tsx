    ...
    const loadInitialData = async () => {
      try {
        ...
        if (reportersResponse.ok) {
          ...
          console.log(
            `👥 تم جلب ${loadedReporters.length} مراسل`,
            loadedReporters
          );
          ...
          if (loadedReporters.length > 0) {
            ...
            console.log(
              `👤 مراسل افتراضي: ${loadedReporters[0].name} (${defaultReporterId})`
            );
          }
        } else {
                ...
                <div className="space-y-4">
                  ...
                  >
                    <input
                      ...
                      onChange={() =>
                        setFormData((prev) => ({ ...prev, publishType: "now" }))
                      }
