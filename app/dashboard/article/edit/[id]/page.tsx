...
import { 
  ...
  Sparkles, Brain, MapPin, Clock, Globe, Settings, MessageSquare, Hash, FileText, CheckCircle,
  XCircle, Lightbulb, Zap, Target, Star, RefreshCw,
  Wand2, Activity, BarChart3, Rocket, Heart,
  Shield, Mail,
  Share2, Calendar, ArrowLeft, Edit3, Info
} from 'lucide-react';
