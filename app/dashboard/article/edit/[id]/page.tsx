    ...
    const fetchArticle = async () => {
      try {
        ...
        setFormData({
          ...
          author_name: articleData.author_name || articleData.author?.name || '',
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        // التحقق من البيانات وتعيينها بشكل صحيح
                  ...
                  {formData.cover_image ? (
                    <>
                      <div className="relative">
                        ...
                        />
                        <div className="absolute inset-0 bg-black bg-opacity-50 rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-200 flex items-center justify-center">
                          <button
                          ...
                          <button
                            onClick={() => {/* سيتم إضافة وظيفة اختيار الصورة لاحقاً */}}
                    ...
                    <>
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                        ...
                        <p className="text-sm text-gray-600 mb-3">لا توجد صورة بارزة</p>
                        <button
