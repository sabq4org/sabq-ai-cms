...
export default function DeepAnalysisPage() {
  ...
  const [textToSpeech, setTextToSpeech] = useState<SpeechSynthesis | null>(
    null
  );
  ...
  // تشخيص المشكلة
  console.log(
    "[DeepAnalysisPage] Component rendered with params:",
    params,
    "loading:",
    loading
  );
  ...
  const getContentHtml = useCallback(() => {
    ...
    if (analysis.rawContent) {
      ...
      if (
        typeof analysis.rawContent === "object" &&
        (analysis.rawContent as any).sections
      ) {
        // استخرج المحتوى من sections
  ...
  const generateTableOfContents = useCallback(() => {
    ...
    const headings =
      sanitizedContent.match(/<h[1-6][^>]*>.*?<\/h[1-6]>/gi) || [];
    ...
    const handleScroll = () => {
      ...
      if (analysis && readingProgress > 0) {
        ...
        const remainingTime = Math.max(
          0,
          totalTime - (totalTime * readingProgress) / 100
        );
  ...
  const searchForArticle = async (identifier: string) => {
    ...
    const searchMethods = [
      ...
      () =>
        fetch(
          `/api/articles/search?title=${encodeURIComponent(
      ...
      if (response.ok) {
        ...
        const analysisData: DeepAnalysisPageProps = {
          ...
          publishedAt: data.publishedAt
            ? new Date(data.publishedAt).toLocaleDateString("ar-SA")
            : new Date().toLocaleDateString("ar-SA"),
          publishedAtHijri: data.publishedAtHijri,
          readTime:
            data.readTime ||
            Math.ceil((data.rawContent || data.content || "").length / 1000) ||
            5,
          views: data.views || 0,
          likes: data.likes || 0,
      ...
      <div className={`min-h-screen ${darkMode ? "bg-gray-900" : "bg-white"}`}>
        <div className="flex items-center justify-center h-screen">
          <div className="text-center max-w-md mx-auto p-6">
            ...
            >
              <div
                className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 h-2 rounded-full animate-pulse"
                style={{ width: "75%" }}
              ></div>
            </div>
      ...
      >
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
            ...
            <nav className="flex flex-wrap items-center gap-2 text-sm mb-10">
              <Link
                href="/"
                className={`flex items-center gap-1 px-3 py-2 rounded-lg transition-all hover:scale-105 ${
                  darkMode
            ...
            <div className="flex items-center gap-3 mb-8">
              <div
                className={`flex items-center gap-2 px-4 py-2 rounded-full ${
                  darkMode
                    ? "bg-gradient-to-r from-blue-900/80 to-purple-900/80 text-blue-300"
                    : "bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800"
                } border ${
                  darkMode ? "border-blue-800/50" : "border-blue-200/50"
                }`}
              >
            ...
            {analysis.lead && (
              <div
                className={`text-xl md:text-2xl leading-relaxed mb-10 max-w-4xl ${
                  darkMode ? "text-gray-300" : "text-gray-700"
                } font-medium`}
              >
                <div
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
              {/* المؤلف */}
              <div
                className={`flex items-center gap-2 p-3 rounded-xl backdrop-blur ${
                  darkMode
                ...
                <div className="relative overflow-hidden rounded-2xl">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <p className="text-xs opacity-80">
                      © {new Date().getFullYear()} سبق AI - جميع الحقوق محفوظة
                    </p>
                  </div>
                </div>
              </div>
            ...
            <main className="lg:col-span-9 lg:order-1">
              ...
              >
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: sanitizeHtml(getContentHtml()),
                  }}
                />
              </article>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-green-50 dark:bg-green-900/20">
                    ...
                    <span className="font-bold text-green-500">
                      {countWordsInElement(contentRef.current).toLocaleString()}{" "}
                      كلمة
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-8 p-6 rounded-2xl bg-gradient-to-r from-amber-50 to-orange-50 dark:from-gray-800 dark:to-gray-700">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm font-medium">
                    {analysis.rating} من 5 ({Math.floor(analysis.views / 10)}{" "}
                    تقييم)
                  </span>
                </div>
              </div>
        ...
        {isMobile && (
          ...
          >
            ...
            <div
              className={`relative mx-2 mb-2 rounded-2xl shadow-xl ${
                darkMode
              ...
              <div className="flex items-center justify-around p-2">
                ...
                <button
                  onClick={() => {
                    setLiked(!liked);
                    toast.success(
                      liked ? "تم إلغاء الإعجاب" : "تم الإعجاب بالمقال"
                    );
                  }}
                  className={`flex flex-col items-center gap-1 p-2 rounded-xl transition-all ${
                    liked
